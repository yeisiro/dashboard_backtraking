...
export const repositionRows: RepositionRow[] = [
  // Gap A — #7834: one long empty stretch split into 3 consecutive legs, ending
  // at the pickup of load #6100.
  { reposition: true, id: 'op-7834-1', gapId: 'g-7834-a', seq: 1, truck: '#7834', cls: 'D', driver: driverForIndex(0), startDate: 'May 11', endDate: 'May 11', lane: 'Wolcott, IN → Louisville, KY', reason: 'Moved empty on dispatch instruction to stage for the next pickup', totalMiles: 176, effectiveHours: 3.1, cost: 208, adherence: 91.5, leakage: 14, nextLoadId: '#6100', nextLoadLane: 'Memphis, TN → Atlanta, GA' },
  { reposition: true, id: 'op-7834-2', gapId: 'g-7834-a', seq: 2, truck: '#7834', cls: 'D', driver: driverForIndex(0), startDate: 'May 11', endDate: 'May 12', lane: 'Louisville, KY → Nashville, TN', reason: 'Continued empty toward the staged pickup market', totalMiles: 172, effectiveHours: 3.0, cost: 198, adherence: 88.0, leakage: 20, nextLoadId: '#6100', nextLoadLane: 'Memphis, TN → Atlanta, GA' },
  { reposition: true, id: 'op-7834-3', gapId: 'g-7834-a', seq: 3, truck: '#7834', cls: 'D', driver: driverForIndex(0), startDate: 'May 12', endDate: 'May 12', lane: 'Nashville, TN → Memphis, TN', reason: 'Final empty leg to the load pickup', totalMiles: 210, effectiveHours: 3.6, cost: 236, adherence: 90.2, leakage: 12, nextLoadId: '#6100', nextLoadLane: 'Memphis, TN → Atlanta, GA' },
  // Gap B — #4467: 2 consecutive legs into the pickup of load #6243.
  { reposition: true, id: 'op-4467-1', gapId: 'g-4467-a', seq: 1, truck: '#4467', cls: 'D', driver: driverForIndex(6), startDate: 'May 4', endDate: 'May 4', lane: 'Omaha, NE → Kansas City, MO', reason: 'Repositioned empty per dispatch after a long dwell', totalMiles: 199, effectiveHours: 3.5, cost: 234, adherence: 82.3, leakage: 31, nextLoadId: '#6243', nextLoadLane: 'St. Louis, MO → Chicago, IL' },
  { reposition: true, id: 'op-4467-2', gapId: 'g-4467-a', seq: 2, truck: '#4467', cls: 'D', driver: driverForIndex(6), startDate: 'May 4', endDate: 'May 5', lane: 'Kansas City, MO → St. Louis, MO', reason: 'Continued empty to reach the booked pickup', totalMiles: 250, effectiveHours: 4.3, cost: 286, adherence: 85.0, leakage: 22, nextLoadId: '#6243', nextLoadLane: 'St. Louis, MO → Chicago, IL' },
  // Single-leg gaps.
  { reposition: true, id: 'op-2210-1', gapId: 'g-2210-a', seq: 1, truck: '#2210', cls: 'D', driver: driverForIndex(2), startDate: 'May 12', endDate: 'May 12', lane: 'Houston, TX → San Antonio, TX', reason: 'Repositioned empty to a higher-demand market per dispatch', totalMiles: 197, effectiveHours: 3.4, cost: 231, adherence: 87.2, leakage: 24, nextLoadId: '#6310', nextLoadLane: 'San Antonio, TX → Dallas, TX' },
  { reposition: true, id: 'op-5012-1', gapId: 'g-5012-a', seq: 1, truck: '#5012', cls: 'A', driver: driverForIndex(1), startDate: 'May 14', endDate: 'May 14', lane: 'Houston, TX → Austin, TX', reason: 'Repositioned empty to pre-stage near a booked pickup', totalMiles: 162, effectiveHours: 2.7, cost: 184, adherence: 95.6, leakage: 6, nextLoadId: '#6355', nextLoadLane: 'Austin, TX → Dallas, TX' },
  { reposition: true, id: 'op-4456-1', gapId: 'g-4456-a', seq: 1, truck: '#4456', cls: 'D', driver: driverForIndex(4), startDate: 'May 8', endDate: 'May 8', lane: 'Sacramento, CA → Stockton, CA', reason: 'Moved empty off a slow lane on dispatch instruction', totalMiles: 49, effectiveHours: 1.0, cost: 72, adherence: 89.0, leakage: 11, nextLoadId: '#6402', nextLoadLane: 'Stockton, CA → Fresno, CA' },
  { reposition: true, id: 'op-8823-1', gapId: 'g-8823-a', seq: 1, truck: '#8823', cls: 'B', driver: driverForIndex(7), startDate: 'May 10', endDate: 'May 10', lane: 'Albuquerque, NM → Santa Fe, NM', reason: 'Short empty move to stage for the morning pickup', totalMiles: 64, effectiveHours: 1.2, cost: 88, adherence: 96.1, leakage: 4, nextLoadId: '#6440', nextLoadLane: 'Santa Fe, NM → Denver, CO' },
]
